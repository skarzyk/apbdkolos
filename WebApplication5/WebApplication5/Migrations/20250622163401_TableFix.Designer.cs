...
namespace WebApplication5.Migrations
{
    ...
    [Migration("20250622163401_TableFix")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication5.Models.Responsible", b =>
                {
                    b.HasOne("WebApplication5.Models.SeedlingBatch", "SeedlingBatch")
                        .WithMany("Responsibles")
                        .HasForeignKey("BatchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebApplication5.Models.Employee", "Employe")
                        .WithMany("Responsibles")
            ...
            modelBuilder.Entity("WebApplication5.Models.SeedlingBatch", b =>
                {
                    b.HasOne("WebApplication5.Models.Nursery", "Nursery")
                        .WithMany("SeedlingBatches")
                        .HasForeignKey("NurseryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebApplication5.Models.TreeSpecies", "TreeSpecies")
                        .WithMany("SeedlingBatches")
